...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
  ...
  <xsl:function name="local:compare-attributes" as="element(xtlc:message)*" visibility="private">
  ...
  <xsl:function name="local:elm-eq" as="xs:boolean" visibility="private">
  ...
  <xsl:function name="local:elm-seq-nr-string" as="xs:string?" visibility="private">
